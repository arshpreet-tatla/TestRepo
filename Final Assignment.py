...
tesla_revenue["Revenue"] = tesla_revenue['Revenue'].astype(str).str.replace(',|\$', '', regex=True)
make_graph(tesla_data[["Date", "Close"]], tesla_revenue[["Date", "Revenue"]], 'Tesla Stock Graph')
...
make_graph(gme_data[["Date", "Close"]], gme_revenue[["Date", "Revenue"]], 'GameStop Stock Graph')
